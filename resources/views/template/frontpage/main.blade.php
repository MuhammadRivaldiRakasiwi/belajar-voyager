...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('frontpage/assets/favicon.ico') }}" />
    <!-- Bootstrap icons-->
...
<body>
    ...
    <section class="showcase">
        <div class="container-fluid p-0">
            ...
            <div class="row g-0">
                <div @if ($key%2==0) class="col-lg-6 text-white showcase-img" @endif @if ($key%2!=0)
                    class="col-lg-6 order-lg-2 text-white showcase-img" @endif
                    style="background-image: url({{ Voyager::image("$post->image") }});"></div>
                <div @if ($key%2==0) class="col-lg-6 my-auto showcase-text" @endif @if ($key%2!=0)
                    class="col-lg-6 order-lg-1 my-auto showcase-text" @endif>
                    <h2>{{ $post->title }}</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3"
                            src="{{ asset('frontpage/assets/img/testimonials-1.jpg') }}" alt="..." />
                        <h5>Margaret E.</h5>
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3"
                            src="{{ asset('frontpage/assets/img/testimonials-2.jpg') }}" alt="..." />
                        <h5>Fred S.</h5>
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3"
                            src="{{ asset('frontpage/assets/img/testimonials-3.jpg') }}" alt="..." />
                        <h5>Sarah W.</h5>
